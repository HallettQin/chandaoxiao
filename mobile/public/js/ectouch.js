...
$(function ($) {
    ...
    $(".s-g-list-con .j-get-one .ect-select").click(function () {
        ...
        t_goods1 = $('.s-g-list-con .j-get-one .ect-select').parents(".j-show-get-val").find(".t-goods1"); //需要获取弹出层em标签
...
function d_messages_btn2(content, btn1, callback) { //确定取消弹出层
    btn1 = btn1 ? btn1 : '确定删除'
    var btn2  = '取消'
    layer.open({
        content: content,
