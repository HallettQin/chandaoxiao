...
$_LANG['notice_gb_ship'] = '备注：拼单活动未处理为成功前，不能发货';
...
$_LANG['dateType'][0] = '天';
$_LANG['dateType_unit'] = '天';
//ecmoban模板堂 --zhuo end

$_LANG['op_confirm'] = '确认';
$_LANG['op_pay'] = '付款';
$_LANG['op_unship'] = '未发货';
$_LANG['op_after_services'] = '售后';
$_LANG['op_prepares'] = '配货';
$_LANG['OP_SPLITS'] = '生成发货单';
$_LANG['OP_CANCELS'] = '取消';
$_LANG['OP_INVALIDS'] = '无效';
...
$_LANG['NOTICE_GB_SHIPS'] = '备注：拼单活动未处理为成功前，不能发货';
$_LANG['NOTICE_PS_SHIPS'] = '备注：预定活动未处理为成功前，不能发货';
