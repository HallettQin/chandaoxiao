...
$_LANG['shop_audit'] = '展厅是否审核（1为已审核，0为未审核）';
$_LANG['shop_state'] = '展厅状态（1为开启，0为关闭）';
$_LANG['qq_number'] = 'QQ号';
$_LANG['msg_mobile_format_error'] = '手机号码格式不正确';
$_LANG['mobile_not_null'] = '手机号码不能为空';
$_LANG['type_not_null'] = '分销类型不能为空';
$_LANG['msg_shop_name_notnull'] = '展厅名称不能为空';
...
$_LANG['mgs_shop_name_notnull'] = '展厅名不能为空';
$_LANG['shop_set'] = '展厅设置';
