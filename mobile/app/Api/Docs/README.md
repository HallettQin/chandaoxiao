...
| API                                                                   | 描述                       |
|:----------------------------------------------------------------------|:--------------------------|
| [ecapi.trade.cart.get](ecapi.trade.cart.get.md)                       | 获取进货单商品              |
| [ecapi.trade.cart.add](ecapi.trade.cart.add.md)                       | 添加一个商品到进货单         |
| [ecapi.trade.cart.update](ecapi.trade.cart.update.md)                 | 更新进货单商品数目          |
| [ecapi.trade.cart.delete](ecapi.trade.cart.delete.md)                 | 从进货单中删除一商品         |
| [ecapi.trade.cart.clear](ecapi.trade.cart.clear.md)                   | 清空进货单中的商品          |
| [ecapi.trade.cart.collect](ecapi.trade.cart.collect.md)               | 将商品移至收藏夹            |
| [ecapi.trade.cart.package.add](ecapi.trade.cart.package.add.md)       | 添加礼包到进货单            |
| [ecapi.trade.cart.favourable.add](ecapi.trade.cart.favourable.add.md) | 添加优惠活动到进货单         |
| [ecapi.trade.cart.count](ecapi.trade.cart.count.md)                   | 查询用户在进货单中的商品数量  |
...
| [ecapi.order.again](ecapi.order.again.md)       | 订单商品添加到进货单  |
