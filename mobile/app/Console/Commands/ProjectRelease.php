...
class ProjectRelease extends \Illuminate\Console\Command
{
	...
	public function handle()
	{
		...
		$free = array('app/Plugins/connect/facebook.php', 'app/Plugins/payment/paypal.php', 'resources/docs/*', 'resources/client/*', 'tests/*', '.bowerrc', '.gitattributes', '.gitignore', 'bower.json', 'CHANGELOG.md', 'composer.json', 'package.json', 'README.md', 'webpack.mix.js');
		$basic = array('app/Modules/Wechat/*', 'app/Modules/Qrpay/*', 'app/Plugins/payment/wxpay.php', 'app/Extensions/Wechat.php', 'app/Extensions/Wxapp.php', 'database/*', 'public/css/console_wechat.css', 'public/css/console_wechat_seller.css', 'public/assets/wechat/*', 'public/assets/qrpay/*', 'public/fonts/wechat/*', 'public/css/wechat/*', 'public/css/wechat.css', 'public/css/wechat.min.css', 'artisan', 'respond_wxh5.php', 'resources/views/respond/index.wxh5.html*');
		$advanced = array('app/Console/Commands/CustomerService.php', 'app/Modules/Chat/Controllers/AdminController.php', 'app/Modules/Chat/Controllers/AdminpController.php', 'app/Modules/Chat/Controllers/IndexController.php', 'app/Modules/Chat/Controllers/LoginController.php', 'app/Modules/Chat/Models/Kefu.php', 'app/Modules/Chat/Views/*', 'app/Modules/Drp/*', 'app/Modules/Team/*', 'app/Modules/Touchim/*', 'app/Extensions/WorkerEvent.php', 'public/css/console_team.css', 'public/css/team.css', 'public/css/team.min.css', 'resources/views/touchim/*');
