...
class Shipping extends \Illuminate\Database\Eloquent\Model
{
	...
	protected $fillable = array('shipping_code', 'shipping_name', 'shipping_desc', 'insure', 'support_cod', 'enabled', 'shipping_print', 'print_bg', 'config_lable', 'print_model', 'shipping_order', 'customer_name', 'customer_pwd');
