	...
	public function actionUrl()
	{
		if (IS_POST) {
			...
			if ($type == 'function') {
				...
				$cart = array('cat_id' => '2', 'cat_name' => '进货单', 'parent_id' => 0, 'url' => url('cart/index/index'));
				$user = array('cat_id' => '3', 'cat_name' => '用户中心', 'parent_id' => 0, 'url' => url('user/index/index'));
				$store = array('cat_id' => '4', 'cat_name' => '展厅街', 'parent_id' => 0, 'url' => url('store/index/index'));
				...
				$activity = array('cat_id' => 5, 'cat_name' => '模式', 'parent_id' => 0, 'url' => url('activity/index/index'));
