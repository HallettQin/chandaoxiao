...
$_LANG['add_group_buy'] = '添加拼单';
$_LANG['edit_group_buy'] = '编辑拼单';

$_LANG['goods_name'] = '商品名称';
$_LANG['start_date'] = '开始时间';
$_LANG['end_date'] = '结束时间';
$_LANG['deposit'] = '保证金';
$_LANG['restrict_amount'] = '目标数量';
...
$_LANG['error_group_buy'] = '您要操作的拼单活动不存在';
...
$_LANG['cancel_order_reason'] = '拼单失败';
$_LANG['js_languages']['succeed_confirm'] = '此操作不可逆，您确定要设置该拼单活动成功吗？';
$_LANG['js_languages']['fail_confirm'] = '此操作不可逆，您确定要设置该拼单活动失败吗？';
$_LANG['button_mail'] = '发送邮件';
$_LANG['notice_mail'] = '（通知客户付清余款，以便发货）';
$_LANG['mail_result'] = '该拼单活动共有 %s 个有效订单，成功发送了 %s 封邮件。';
$_LANG['invalid_time'] = '您输入了一个无效的拼单时间。';
$_LANG['add_success'] = '添加拼单成功。';
$_LANG['edit_success'] = '编辑拼单成功。';
$_LANG['back_list'] = '返回拼单列表。';
$_LANG['continue_add'] = '继续添加拼单，';
$_LANG['error_goods_null'] = '您没有选择拼单商品！';
$_LANG['error_goods_exist'] = '您选择的商品目前有一个拼单活动正在进行！';
$_LANG['error_price_ladder'] = '您没有输入有效的价格阶梯！';
$_LANG['error_restrict_amount'] = '限购数量不能小于价格阶梯中的最大数量';
$_LANG['js_languages']['error_goods_null'] = '您没有选择拼单商品！';
...
$_LANG['js_languages']['batch_drop_confirm'] = '您确定要删除选定的拼单活动吗？';
$_LANG['error_exist_order'] = '该拼单活动已经有订单，不能删除！';
$_LANG['batch_drop_success'] = '成功删除了 %s 条拼单活动记录（已经有订单的拼单活动不能删除）。';
$_LANG['no_select_group_buy'] = '您现在没有拼单活动记录！';
$_LANG['log_action']['group_buy'] = '拼单商品';
$_LANG['prompt'] ='（提示）';
