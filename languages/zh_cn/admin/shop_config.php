...
$_LANG['cfg_name']['group_goods_number'] = '拼单商品的数量';
...
$_LANG['cfg_name']['show_goods_in_cart'] = '进货单里显示商品方式';
$_LANG['cfg_name']['show_attr_in_cart'] = '进货单里是否显示商品属性';
...
$_LANG['cfg_name']['cart_confirm'] = '进货单确定提示';
...
$_LANG['cfg_desc']['cart_confirm'] = '允许您设置用户点击“加入进货单”后是否提示以及随后的动作。';
...
$_LANG['cfg_range']['cart_confirm'][1] = '提示用户，点击“确定”进进货单';
$_LANG['cfg_range']['cart_confirm'][2] = '提示用户，点击“取消”进进货单';
$_LANG['cfg_range']['cart_confirm'][3] = '直接进入进货单';
...
$_LANG['cfg_desc']['category_load_type'] = '设置分类/搜索/促销活动（拼单活动、积分商城、夺宝奇兵、拍卖活动等）页下商品加载的方式';
