...
$_LANG['Appointment'] = "预定中";
$_LANG['array_order'] = "排列";
$_LANG['existing'] = "已有";
$_LANG['subscribe_p'] = "人预定";
$_LANG['Start_from'] = "距开始";
$_LANG['Count_down'] = "倒计时";
$_LANG['Signature_recommendation'] = "招牌推荐";
$_LANG['share'] = "分享";
$_LANG['Start_from_presell'] = "距离预定开始";
$_LANG['hour_two'] = '时';
$_LANG['minutes'] = '分';
$_LANG['seconds'] = '秒';
$_LANG['Pre_sale_rules'] = "预定规则";
$_LANG['presell_desc'] = '<li><b>1.</b>订金下单后，请在30分钟内付款，超时将自动关闭订单。</li>
                                                    <li><b>2.</b>订金付款后，若非';
$_LANG['presell_desc_one'] = '或商家责任（根据《售后政策》和客服判断为准），订金恕不退还；</li>
                                                    <li><b>3.</b>预定结束时，由系统自动更新确认尾款金额，无论下单顺序先后均可享受相同的预定价格；</li>
                                                    <li><b>4.</b>预定结束后，请至';
$_LANG['presell_desc_two'] = '“我的订单”内付尾款；</li>
                                                    <li><b>5.</b>尾款开始支付时，请在要求的时间（72小时）内支付尾款，若超时将自动关闭订单，且订金不予退还。请注意预定结束时间，并及时支付尾款，对此我们会有短信提醒；</li>
                                                    <li><b>6.</b>时间达到预定目标量未达到，预定金返还，不发货；预定目标量达到时间未达到，预定金不返还，正常发货；</li>
                                                    <li><b>7.</b>发货时间请以预定商品详情页中的“发货时间”描述为准；</li>';
$_LANG['Advance_sale_price'] = "预 订 价";
$_LANG['Deposit'] = "订　　金";
$_LANG['Deposit_new'] = "订 金";
$_LANG['Retainage'] = "尾　　款";
...
$_LANG['Freight'] = "运　　费";
$_LANG['gs_number'] = '数　　量';
$_LANG['presale_no_start'] = "预定未开始";
$_LANG['presale_end'] = "预定已结束";
$_LANG['Pay_deposit'] = "支付订金";
$_LANG['presrll_desc_end'] = "该预定活动已经结束或尚未开始，现在不能参加！";
$_LANG['presale_process'] = "预定流程";
$_LANG['Pay_deposit'] = "支付订金";
...
$_LANG['make_appointment_now'] = "立即预定";
