...
$_LANG['order_is_group_buy'] = '[拼单]';
$_LANG['order_is_exchange'] = '[积分商城]';
$_LANG['order_is_presale'] = '[预定]';
$_LANG['order_is_auction'] = '[拍卖活动]';
$_LANG['order_is_seckill'] = '[秒杀活动]';
$_LANG['order_is_snatch'] = '[夺宝奇兵]';
$_LANG['order_is_wholesale'] = '[现货]';
$_LANG['order_is_sample'] = '[样品]';
$_LANG['gb_deposit'] = '（保证金）';
$_LANG['notice_gb_order_amount'] = '（备注：拼单如果有保证金，第一次只需支付保证金和相应的支付费用）';
...
$_LANG['return_to_cart_success'] = '订单中商品已经成功加入进货单中';
...
/* 密码找回问题 */
$_LANG['enterprise_type']['purchasers'] = '终端零售商';
$_LANG['enterprise_type']['supplier']     = '生产制造商';
...
$_LANG['apply_success'] = "申请提交成功，工作人员将尽快审核！";
...
$_LANG['Repair_number'] = "数量";
$_LANG['Repair_one'] = "可供退款";
$_LANG['Repair_two'] = "件，已退款";
$_LANG['jian'] = "件";
