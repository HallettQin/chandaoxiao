...
/* 团购部分语言项 */
$_LANG['group_buy_list'] = '拼单列表';
$_LANG['group_buy'] = '拼单活动';
$_LANG['group_buy_goods'] = '拼单商品';
$_LANG['gb_goods_name'] = '拼单商品：';
$_LANG['gb_start_date'] = '开始时间：';
$_LANG['gb_end_date'] = '结束时间：';
$_LANG['gbs_pre_start'] = '该拼单活动尚未开始，请继续关注。';
$_LANG['gbs_under_way'] = '该拼单活动正在火热进行中，距离结束时间还有：';
$_LANG['gbs_finished'] = '该拼单活动已结束，正在等待处理...';
$_LANG['gbs_succeed'] = '该拼单活动已成功结束！';
$_LANG['gbs_fail'] = '该拼单活动已结束，没有成功。';
...
$_LANG['gb_notice_login'] = '提示：您需要先注册成为本站会员并且登录后，才能参加商品拼单!';
$_LANG['gb_error_goods_lacking'] = '对不起，商品库存不足，请您修改数量！';
$_LANG['gb_error_restrict_amount'] = '对不起，您购买的商品数量已达到限购数量！';
$_LANG['gb_error_status'] = '对不起，该拼单活动已经结束或尚未开始，现在不能参加！';
$_LANG['gb_error_login'] = '对不起，您没有登录，不能参加拼单，请您先登录！';
$_LANG['group_goods_empty'] = '当前没有拼单活动';

/* 预售部分语言项 */
$_LANG['presale_error_status'] = '对不起，该预定活动已经结束或尚未开始，现在不能参加！';
$_LANG['back_to_presale'] = '返回预定商品';
//$_LANG['presale_error_status'] = '对不起，该预售活动已经结束或尚未开始，现在不能参加！';
//$_LANG['back_to_presale'] = '返回预售商品';
$_LANG['error_restrict_amount'] = '对不起，您购买的商品数量已达到限购数量！';
$_LANG['error_goods_lacking'] = '对不起，商品库存不足，请您修改数量！';
...
$_LANG['successfully_added_shoping'] = "宝贝已成功添加到进货单！";
$_LANG['cart_count'] = "进货单共有";
...
$_LANG['goods_null_cart'] = "进货单中还没有商品，赶紧选购吧！";
$_LANG['sort'] = '排序';
...
$_LANG['Newest'] = "最新";
$_LANG['moq_error'] = '您订购的商品: %s 少于最小起订量 %s 件';
$_LANG['gb_error_restrict_amount1'] = '对不起，您购买的商品: %s 数量已达到限购数量！';
$_LANG['gb_error_status_1'] = '对不起，该%s: %s 已经结束或尚未开始，现在不能参加！';
$_LANG['gb_error_status_2'] = '对不起，该%s: %s 已下架！';
$_LANG['gb_error_status_3'] = '活动已经结束！';
?>