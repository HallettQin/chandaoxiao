...
            var isIE7=isIE&&!isIE6&&!isIE8;
			...
			if(isIE8 || isIE7){
				if(document.getElementById("scrollBody") && document.getElementById("scrollBody").attachEvent) {
                    document.getElementById("scrollBody").onmousewheel = wheel;
                }

                document.getElementById("scrollBody") && document.getElementById("scrollBody").attachEvent('DOMMouseScroll',wheel,false);
			}else{
				if(document.getElementById("scrollBody") && document.getElementById("scrollBody").addEventListener) {
                    document.getElementById("scrollBody") && document.getElementById("scrollBody").addEventListener('DOMMouseScroll', wheel, true);
                }
