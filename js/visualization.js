		...
		function db_column(){
			...
			$(window).ready(function(e) {
            	if($(".demo").hasClass("store_default_temp1")){
					$(".module-list").find("*[data-mode='storeOneFloor1']").show().siblings().hide();
				}else if($(".demo").hasClass("store_default_temp2")){
					$(".module-list").find("*[data-mode='storeTwoFloor1']").show().siblings().hide();
				}else if($(".demo").hasClass("store_default_temp3")){
					$(".module-list").find("*[data-mode='storeThreeFloor1']").show().siblings().hide();
				}else if($(".demo").hasClass("store_default_temp4")){
					$(".module-list").find("*[data-mode='storeFourFloor1']").show().siblings().hide();
				}else if($(".demo").hasClass("store_default_temp5")){
					$(".module-list").find("*[data-mode='storeFiveFloor1']").show().siblings().hide();
				}
            });
		}
		db_column();
