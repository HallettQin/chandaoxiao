...
//		$where .= " AND g.is_on_sale = 1 ";
    ...
    if($type == 1){
        $list = getGoodslist($where,$sort, ',g.good_mode');
        $list_arr = [];
...
//                $row = array_merge($row, $ext_info);
        ...
        $sql = "SELECT g.promote_start_date, g.good_mode, g.promote_end_date, g.promote_price, g.goods_name, g.goods_id, g.goods_thumb, g.shop_price, g.market_price, g.original_img FROM " .
